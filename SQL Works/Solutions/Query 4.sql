...
pro2021 as (select distinct segment, count(product) as product_count_2021 from dim_product t3 join fact_sales_monthly t4 on t3.product_code = t4.product_code where fiscal_year = 2021 group by segment)
